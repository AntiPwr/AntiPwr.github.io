...
The campaign will be called, <a href="Whispers of the Well.md">Whispers of the Well</a>, taking place within the plane of <a href="Toma.md">Toma</a>. Although, as seen with the name of the wiki, the <a href="Scape.md">Scape</a> is the name of the universe. Currently, the significance of the Scape remains undiscovered. For more background information on the world, see <a href="#World Information">World Information</a>.

<details open>
<summary><h3>Unlock System</h3></summary>

The <a href="Unlock System.md">Unlock System</a> slowly introduces new homebrew classes, spells, and races as the party progresses. Once unlocked, these options will be available to all.
...
The <a href="Merchant System.md">Merchant System</a> encompasses a grouping of belief-based magic frameworks within the Toman Ecoss, including <a href="Source Surges.md">Source Surges</a>, <a href="Discovery Inspiration.md">Discovery Inspiration</a>, and <a href="Sea Level Spells.md">Sea Level Spells</a>. Its purpose is to let characters harness the power of their beliefs, translating them into tangible abilities that enhance both roleplay and narrative immersion.
...
<a href="Purpose Taxonomy.md">Purpose Taxonomy</a> is an ancient classification system that categorizes existence, guiding understanding of souls, belief, and governance:

- <a href="Eco.md">Eco</a> (Plane) (Theoretical)  
- <a href="Kingdom.md">Kingdom</a> (Inhabitant)  
- <a href="Phylum.md">Phylum</a> (Ideology)  
- <a href="Class.md">Class</a> (Government)  
- <a href="Order.md">Order</a> (Civilization)  
- <a href="Family.md">Family</a> (Community)  
- <a href="Essa.md">Essa</a> (Soul’s Purpose) (Theoretical)
...
Toma’s timeline is divided into Lines, each concluding with a rotation shift of the <a href="World Gyre.md">World Gyre</a>:

- <a href="Taxotheir Line.md">Taxotheir Line</a>: Marked by the formation of early governance, intense conflict over Hollow Resources, and the beginnings of structured Purpose Taxonomy. Rivalries like Esterik vs. Scepitath define this era.
  
- <a href="Cel Blindbirth Line.md">Cel Blindbirth Line</a>: Following the Taxotheir Line’s devastation, Celia and Primordials quickly began to dominate the overground. Huma populations slowly became the crossfire for a war between these kingdoms, forcing Huma societies to reposition underground as the conflicts ramped up. During this time in the subterrain, the Huma population fell steadily, falling to just 4% of the original population before bouncing back in the next line.  This era’s horrors reshaped society, setting the stage for future recoveries.
  
- <a href="Line from Few.md">Line from Few</a>: After emerging from subterranean refuges as Celia’s dominance waned, survivors reclaimed surface regions. Societies like Sol Unita (from Scepitath) and the Branches of Concordia (from Esterik) formed, establishing new balances of faith, trade, and governance.
...
- **Cleric**: Official subclasses; (Homebrew) Asceptim Domain  
- **Druid**: Official subclasses  
- **Fighter**: Official subclasses  
- **Monk**: Official subclasses; (Homebrew) Way of the Slime  
- **Paladin**: Official subclasses  
- **Ranger**: Official subclasses; (Homebrew) Celia Conclave  
- **Rogue**: Official subclasses  
- **Sorcerer**: Official subclasses; (Homebrew) Belief Gambit  
